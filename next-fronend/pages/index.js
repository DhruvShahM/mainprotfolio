...
export default function Home({ blogs,profile }) {
  ...
  //   fblink:"https://www.facebook.com/dhruv.shah.58910049/",
  //   instagramlink:"https://www.instagram.com/dhruv_shah72/?hl=en",
  //   twitterlink:"https://twitter.com/dhruvshah78223",
  //   title:"WorkWithDhruv",
  //   linkedinlink:"https://www.linkedin.com/in/dhruvf/"
  // }
  ...
  return (
    ...
    <><>
      ...
      <Head>
        ...
        <title>{profile.title} - Devloper | Coder | Software Geek</title>
  ...
  ">
        <div className="container flex items-center justify-between">
          <div>
            <a href="/">
              <h2 className='text-white text-2xl font-bold'>CodeWithDhruv</h2>
            </a>
          </div>
        ...
        >
          <div className="absolute right-0 min-h-screen w-2/3 bg-primary py-4 px-8 shadow md:w-1/3">
            <button className="absolute top-0 right-0 mt-4 mr-4">
              <img src={builder.image(profile.image).width(200).url()} className="h-10 w-auto" alt="" />
            </button>
            ...
            <div className="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
              <div className="flex flex-col items-center justify-center lg:flex-row">
                <div className="rounded-full border-8 border-primary shadow-xl">
                  <img src="/assets/img/profile.jpg" className="h-48 rounded-full sm:h-56" alt="author" />
                </div>
              ...
              <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
                {blogs.map((item) => {
                  ...
                  return <Link key={item.slug.current} href={"/blog/" + item.slug.current} className="shadow cursor-pointer">
                    <div>
                      <div style={{ "backgroundImage": `url(${builder.image(item.blogimage).width(200).url() || '/assets/img/post-03.png'})` }}
